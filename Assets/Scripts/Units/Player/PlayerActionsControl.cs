...
//     version 1.19.0
//     from Assets/Scripts/Units/Player/PlayerActionsControl.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Units/Player/PlayerActionsControl.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @PlayerActionsControl: IInputActionCollection2, IDisposable
{
    /// <summary>
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""OnPause"",
                    ""type"": ""Button"",
                    ""id"": ""a767b1e0-c60a-4faf-847f-bddb91d2bf26"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""2b6e2e24-17c0-4ac8-ac9c-af4337ebb5a2"",
    ...
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlayerActionsControl.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, PlayerActionsControl.UI.Disable() has not been called.");
    }
